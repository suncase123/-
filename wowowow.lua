...
StratXLibrary.UtilitiesConfig = {
  ...
  Autorejoinlobby = getgenv().Autorejoinlobby or false,
...
function SaveUtilitiesConfig()
    ...
    Autorejoinlobby = UtilitiesTab.flags.Autorejoinlobby,
...
if CheckPlace() then
	...
	UtilitiesTab:Toggle("Rejoin Lobby After Match",{flag = "RejoinLobby", default = UtilitiesConfig.Autorejoinlobby, location = StratXLibrary})
